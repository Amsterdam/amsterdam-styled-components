...
storiesOf('Atoms/Radio', module)
  ...
  .add('variants', () => (
    <>
      <RadioGroup name="group" horizontal>
      ...
      <RadioGroup>
        <Label htmlFor="radio-3" label="Radio 1">
          <Radio id="radio-3" name="group-2" />
        </Label>
        <Label htmlFor="radio-4" label="Radio 2">
          <Radio id="radio-4" name="group-2" />
        </Label>
      </RadioGroup>
    </>
  ))
